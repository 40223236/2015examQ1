...
class Hello(object):
    ...
    def aaa(self, n_g1=15, n_g2=24,M=5, P=15):
         ...
         if n_g1 < 15:
            return "齒輪1 需介於15~80" + self.threeDgear()
         elif n_g1 > 80:
            return "齒輪1 需介於15~80 " + self.threeDgear()
         elif n_g2 < 15:
            return "齒輪2 需介於15~80 " + self.threeDgear()
         elif n_g2 > 80:
            return "齒輪2 需介於15~80 " + self.threeDgear()
         else:
    ...
    @cherrypy.expose
    # N 為齒數, M 為模數, P 為壓力角
    def index(self, n_g1=15, n_g2=24,M=5, P=15):
        outstring = '''
    <!DOCTYPE html> 
    <html>
    <head>
    ...
    <canvas id="plotarea" width="3800" height="3500"></canvas>
